...
public class TargetedAd {
  ...
  public static void main(String[] args) {
    ...
    /* your code here */
    DataCollector pets = new DataCollector();
    pets.setData("socialMediaPosts.txt", "targetWords.txt");
    String x = pets.findUsernames();
    pets.prepareAdvertisement("targetedUsernames", x, "Have a pet? Buy this revolutionary collar!");
