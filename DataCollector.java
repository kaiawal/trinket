...
public class DataCollector {
  ...
  /**
   * sss Get the next post in socialMediaPosts with words separated by a single
   * space, or "NONE" if there is no more data.
   * 
  ...
  /**
   * Get the next line in targetWords, with words separated by a space, or "NONE"
